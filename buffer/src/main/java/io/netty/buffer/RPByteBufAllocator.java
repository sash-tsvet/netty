...
public class RPByteBufAllocator  extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(RPByteBufAllocator.class);
...
//    private final int chunkSize;
    private final RPByteBufAllocatorMetric metric = new RPByteBufAllocatorMetric(this);

    public RPByteBufAllocator() {
        this(false);
    }

    @SuppressWarnings("deprecation")
    public RPByteBufAllocator(boolean preferDirect) {
//        this(preferDirect, DEFAULT_NUM_HEAP_ARENA, DEFAULT_NUM_DIRECT_ARENA, DEFAULT_PAGE_SIZE, DEFAULT_MAX_ORDER);
    }

    @SuppressWarnings("deprecation")
    public RPByteBufAllocator(int nHeapArena, int nDirectArena, int pageSize, int maxOrder) {
//        this(false, nHeapArena, nDirectArena, pageSize, maxOrder);
     ...
     */
    @Deprecated
    public RPByteBufAllocator(boolean preferDirect, int nHeapArena, int nDirectArena, int pageSize, int maxOrder) {
...
//                normalCacheSize, DEFAULT_USE_CACHE_FOR_ALL_THREADS, DEFAULT_DIRECT_MEMORY_CACHE_ALIGNMENT);
    ...
    public RPByteBufAllocator(boolean preferDirect, int nHeapArena,
...
//        super(preferDirect);
//        threadCache = new PooledByteBufAllocator.PoolThreadLocalCache(useCacheForAllThreads);
...
//        PoolArena<byte[]> heapArena = cache.heapArena;
        ...
        final ByteBuf buf;
        buf = heapHeap.allocate(initialCapacity, maxCapacity);//allocate(cache, initialCapacity, maxCapacity);
...
//        PoolArena<ByteBuffer> directArena = cache.directArena;
        ...
        final ByteBuf buf;
        buf = directHeap.allocate(initialCapacity, maxCapacity);//allocate(cache, initialCapacity, maxCapacity);
...
//    }
    ...
    @Override
    public RPByteBufAllocatorMetric metric() {
        return this.metric;
    }
//
//    /**
